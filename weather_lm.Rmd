...
We first assessing the relationship between n_incidents and our predictor variables
```{r, warning=F, message=F}
p1 = df %>% 
...
#### In the next section, we apply Bootsrapping to obtain estimates without making parameteric assumptions
