...
crash_api_2019 = function(offset) {
  GET("https://data.cityofnewyork.us/resource/h9gi-nx95.csv", 
      query = list("$where" = "crash_date between '2019-01-01T00:00:00' and '2019-10-31T12:00:00'", "$limit" = 50000, "$offset" = offset)) %>% 
  content("parsed") %>%
  as_tibble() 
}
...
offsets = c(0, 50000)
crash_dat = bind_rows(map_df(offsets, crash_api_2019), 
...
Microvehicel incidents in NYC _ a leaflet map
```{r, include=FALSE}
bikes %>%
